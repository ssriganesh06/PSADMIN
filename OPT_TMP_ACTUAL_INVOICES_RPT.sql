SELECT A.BUSINESS_UNIT, A.INVOICE, B.INVOICE, B.INVOICE_AMOUNT, A.INVOICE_AMOUNT, TO_CHAR(A.INVOICE_DT,'YYYY-MM-DD'), A.BUSINESS_UNIT_PC, A.PROJECT_ID, A.BILL_TO_CUST_ID, A.BILL_STATUS, A.CONTRACT_NUM, A.BILL_TYPE_ID, A.BILL_CYCLE_ID, TO_CHAR(CAST((A.ADD_DTTM) AS TIMESTAMP),'YYYY-MM-DD-HH24.MI.SS.FF') 
...
UNION 
SELECT E.BUSINESS_UNIT, ' ', E.INVOICE, E.INVOICE_AMOUNT, 0, TO_CHAR(E.INVOICE_DT,'YYYY-MM-DD'), E.BUSINESS_UNIT_PC, E.PROJECT_ID, E.BILL_TO_CUST_ID, E.BILL_STATUS, E.CONTRACT_NUM, E.BILL_TYPE_ID, E.BILL_CYCLE_ID, TO_CHAR(CAST((E.ADD_DTTM) AS TIMESTAMP),'YYYY-MM-DD-HH24.MI.SS.FF') 
  FROM PS_BI_HDR E 
  WHERE E.PO_REF = E.PO_REF 
     AND E.INVOICE LIKE 'TMP%' 
     AND E.CONTRACT_NUM <> ' ' 
  ...
  WHERE F.INVOICE NOT LIKE 'TMP%' 
     ...
     AND E.CNTCT_SEQ_NUM = F.CNTCT_SEQ_NUM 
     AND E.CONTRACT_NUM = F.CONTRACT_NUM 
     AND E.PO_REF = F.PO_REF 
...
UNION 
SELECT J.BUSINESS_UNIT, J.INVOICE, ' ', 0, J.INVOICE_AMOUNT, TO_CHAR(J.INVOICE_DT,'YYYY-MM-DD'), J.BUSINESS_UNIT_PC, J.PROJECT_ID, J.BILL_TO_CUST_ID, J.BILL_STATUS, J.CONTRACT_NUM, J.BILL_TYPE_ID, J.BILL_CYCLE_ID, TO_CHAR(CAST((J.ADD_DTTM) AS TIMESTAMP),'YYYY-MM-DD-HH24.MI.SS.FF') 
  FROM PS_BI_HDR J 
  ...
  WHERE K.INVOICE LIKE 'TMP%' 
     ...
     AND J.CNTCT_SEQ_NUM = K.CNTCT_SEQ_NUM 
     AND J.CONTRACT_NUM = K.CONTRACT_NUM 
     AND J.PO_REF = K.PO_REF 
